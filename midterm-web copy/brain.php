    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-6">
              <img class="img-fluid d-block w-100 mb-3 rounded" src="Images/justBrain.jpg">
              <h1 class="">Origin</h1>
              <p class="">
This meme originated as part of the “Whomst” meme where the left column was derivations of the word “Who” were paired with increasingly elaborate pictures of brains depending on how intense the “who” variation was. One of the most popular early examples was posted to /r/dankmemes on January 31st, 2017 by janskishimanski in a post that gained nearly 1,200 upvotes.</p>
            </div>
            <div class="col-md-6">
              <img class="img-fluid d-block w-100 mb-3 rounded" src="Images/brain.jpg">
              <h1 class="">Spread</h1>
              <p class="">As “whomst” variations on the Expanding Brain template grew more elaborate, other subjects were applied to Expanding Brain, such as video games and politics. Expanding Brain variations continued appearing on /r/dankmemes and /r/MemeEconomy throughout the month of February.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row mb-5">
        ...
        <div class="col-md-5 align-self-center">
          <img class="img-fluid d-block w-100 img-thumbnail" src="Images/pizzaBrain.png"> </div>
      </div>
    </div>
  </div>
